...
$(".video-thumb:nth-child(1)")
  .clone()
  .appendTo(".video-thumbs")
  .addClass("clone first-clone");

$(".video-thumbs")
  .find(".video-thumb:nth-child(5)")
  .removeClass("active thumb-1")
  .attr("index", "5");

$(".video-thumb:nth-child(4)").clone().prependTo(".video-thumbs");

$(".video-thumbs")
  .find(".video-thumb:nth-child(1)")
  .removeClass("active")
  .addClass("clone last-clone")
  .attr("index", "0");
